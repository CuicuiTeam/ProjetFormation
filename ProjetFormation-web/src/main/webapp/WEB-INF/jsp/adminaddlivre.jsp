...
<form:form modelAttribute="livre" class="form-horizontal">
	<fieldset>
		...
		<div class="form-group">
			<label class="control-label col-lg-2" for="date">Date de publication</label>
			<div class="col-lg-10">
				<form:input id="date" path="datePublication" type="date" required="required"
					class="form:input-large" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-lg-10">
				<form:input id="image" path="imagePath" type="text" required="required"
					class="form:input-large" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-lg-10">
				<form:checkbox id="populaire" path="isPopular"/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-lg-2" for="periodique">Periodique</label>
			<div class="col-lg-10">
				<form:checkbox id="periodique" path="isPeriodic"/>
			</div>
		</div>
		<div class="form-group">
			<div class="col-lg-10 col-lg-offset-2">
				<input type="submit" id="btnAdd" class="btn btn-primary" value="Ajouter et revenir à l'accueil" />
			</div>
		</div>
		<div class="form-group">
			<div class="col-lg-10 col-lg-offset-2">
				<input type="submit" id="btnAdd" class="btn btn-primary" value="Ajouter et créer un nouveau livre" />
			</div>
		</div>
	</fieldset>
</form:form>
