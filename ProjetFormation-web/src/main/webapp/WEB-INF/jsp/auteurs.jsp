			...
			<div class="col-lg-4" style="padding-bottom: 30px">
				...
				<div class="caption">
					<div class="panel panel-default"
						style="background-color: #eee; border-color: #999">
						<h3 class="text-center">
							<i>${auteur.prenom}</i> <b>${auteur.nom}</b>
						</h3>
						<c:if test="${!empty auteur.imagePath}">
							<img src="<c:url value="/ressources/${auteur.imagePath}"/>"
						...
						<button type="button"
							class="btn btn-outline-success and-all-other-classes center-block"
